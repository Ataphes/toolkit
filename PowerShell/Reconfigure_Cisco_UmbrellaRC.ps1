...
copy-item -Path "\\osshare\ossmc$\Southfield\Scripts\SFD_Reconfigure_Cisco_UmbrellaRC\OrgInfo.json" -Destination "C:\ProgramData\OpenDNS\ERC\OrgInfo.json" -Force
