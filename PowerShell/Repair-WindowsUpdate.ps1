## Purpose: To ensure all components of windows update are working correcly. Sourced from (https://github.com/Gaz2600/Reset-Windows-Update/blob/main/RstWinUpd.ps1)
## Maintainer: Joseph Walczak (joseph.walczak@oakland.k12.mi.us)
